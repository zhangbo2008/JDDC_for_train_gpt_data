...
答：".format(len(history), query)
    ...
    if training_args.do_train:# 准备好训练数据集.
    ...
    print('打印测试集')
    t=raw_datasets["test"][:numto_train_test]
    for i in t:
      print(i)
...
!CUDA_VISIBLE_DEVICES=0 python3 main.py \
    --do_train \
    --do_predict False \
    --train_file /content/JDDC_for_train_gpt_data/extract_train.json \
    --test_file /content/JDDC_for_train_gpt_data/extract_train.json \
